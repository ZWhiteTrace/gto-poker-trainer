...
function generateThreeLayerScenario(): ThreeLayerScenario {
  ...
  const targetTexture =
    template.textureHint[Math.floor(Math.random() * template.textureHint.length)];
...
const MUST_CHECK_CATEGORIES = [
  {
    id: "mid_wet_air",
    nameKey: "flopTexture.mustCheck.cat.midWetAir",
    descKey: "flopTexture.mustCheck.cat.midWetAirDesc",
  },
  {
    id: "low_board_no_overpair",
    nameKey: "flopTexture.mustCheck.cat.lowBoardNoOverpair",
    descKey: "flopTexture.mustCheck.cat.lowBoardNoOverpairDesc",
  },
  {
    id: "connected_weak_made",
    nameKey: "flopTexture.mustCheck.cat.connectedWeakMade",
    descKey: "flopTexture.mustCheck.cat.connectedWeakMadeDesc",
  },
  {
    id: "monotone_no_flush",
    nameKey: "flopTexture.mustCheck.cat.monotoneNoFlush",
    descKey: "flopTexture.mustCheck.cat.monotoneNoFlushDesc",
  },
  {
    id: "broadway_no_backdoor",
    nameKey: "flopTexture.mustCheck.cat.broadwayNoBackdoor",
    descKey: "flopTexture.mustCheck.cat.broadwayNoBackdoorDesc",
  },
  {
    id: "villain_range_advantage",
    nameKey: "flopTexture.mustCheck.cat.villainRangeAdv",
    descKey: "flopTexture.mustCheck.cat.villainRangeAdvDesc",
  },
  {
    id: "oop_wet_board",
    nameKey: "flopTexture.mustCheck.cat.oopWetBoard",
    descKey: "flopTexture.mustCheck.cat.oopWetBoardDesc",
  },
  {
    id: "protect_check_range",
    nameKey: "flopTexture.mustCheck.cat.protectCheckRange",
    descKey: "flopTexture.mustCheck.cat.protectCheckRangeDesc",
  },
  {
    id: "turn_will_change",
    nameKey: "flopTexture.mustCheck.cat.turnWillChange",
    descKey: "flopTexture.mustCheck.cat.turnWillChangeDesc",
  },
  {
    id: "no_clear_purpose",
    nameKey: "flopTexture.mustCheck.cat.noClearPurpose",
    descKey: "flopTexture.mustCheck.cat.noClearPurposeDesc",
  },
];
...
const MUST_CHECK_SCENARIOS_DATA: Array<{
  ...
  // 中張濕牌面空氣牌
  {
    ...
    position: "IP",
    heroHand: "AhKc",
    heroHandTypeKey: "flopTexture.mustCheck.sc.0.handType",
    shouldCheck: true,
    categoryId: "mid_wet_air",
    reasonKey: "flopTexture.mustCheck.sc.0.reason",
  },
  {
    textureHint: ["JT_conn", "Low_conn"],
    position: "IP",
    heroHand: "QcJc",
    heroHandTypeKey: "flopTexture.mustCheck.sc.1.handType",
    shouldCheck: false,
    categoryId: "mid_wet_air",
    reasonKey: "flopTexture.mustCheck.sc.1.reason",
  },

  // 低牌面無 Overpair
  {
    textureHint: ["Low_unconn"],
    position: "IP",
    heroHand: "AhQc",
    heroHandTypeKey: "flopTexture.mustCheck.sc.2.handType",
    shouldCheck: true,
    categoryId: "low_board_no_overpair",
    reasonKey: "flopTexture.mustCheck.sc.2.reason",
  },
  {
    textureHint: ["Low_unconn"],
    position: "IP",
    heroHand: "TsTc",
    heroHandTypeKey: "flopTexture.mustCheck.sc.3.handType",
    shouldCheck: false,
    categoryId: "low_board_no_overpair",
    reasonKey: "flopTexture.mustCheck.sc.3.reason",
  },

  // 連接牌面弱成牌
  {
    textureHint: ["BBx", "JT_conn"],
    position: "IP",
    heroHand: "9h9c",
    heroHandTypeKey: "flopTexture.mustCheck.sc.4.handType",
    shouldCheck: true,
    categoryId: "connected_weak_made",
    reasonKey: "flopTexture.mustCheck.sc.4.reason",
  },
  {
    textureHint: ["BBx", "JT_conn"],
    position: "IP",
    heroHand: "JsJc",
    heroHandTypeKey: "flopTexture.mustCheck.sc.5.handType",
    shouldCheck: false,
    categoryId: "connected_weak_made",
    reasonKey: "flopTexture.mustCheck.sc.5.reason",
  },
  ...
  // 單花面無同花
  {
    ...
    position: "IP",
    heroHand: "AhKh",
    heroHandTypeKey: "flopTexture.mustCheck.sc.6.handType",
    shouldCheck: true,
    categoryId: "monotone_no_flush",
    reasonKey: "flopTexture.mustCheck.sc.6.reason",
  },
  {
    textureHint: ["ABx", "BBx"],
    position: "IP",
    heroHand: "AsKs",
    heroHandTypeKey: "flopTexture.mustCheck.sc.7.handType",
    shouldCheck: false,
    categoryId: "monotone_no_flush",
    reasonKey: "flopTexture.mustCheck.sc.7.reason",
  },
  ...
  // OOP 濕潤牌面
  {
    ...
    position: "OOP",
    heroHand: "AhAc",
    heroHandTypeKey: "flopTexture.mustCheck.sc.8.handType",
    shouldCheck: true,
    categoryId: "oop_wet_board",
    reasonKey: "flopTexture.mustCheck.sc.8.reason",
  },
  {
    textureHint: ["Axx"],
    position: "OOP",
    heroHand: "AhAc",
    heroHandTypeKey: "flopTexture.mustCheck.sc.9.handType",
    shouldCheck: false,
    categoryId: "oop_wet_board",
    reasonKey: "flopTexture.mustCheck.sc.9.reason",
  },
  ...
  // 下注目的不明
  {
    ...
    position: "IP",
    heroHand: "KhQc",
    heroHandTypeKey: "flopTexture.mustCheck.sc.10.handType",
    shouldCheck: true,
    categoryId: "no_clear_purpose",
    reasonKey: "flopTexture.mustCheck.sc.10.reason",
  },
  {
    textureHint: ["ABx"],
    position: "IP",
    heroHand: "KhQc",
    heroHandTypeKey: "flopTexture.mustCheck.sc.11.handType",
    shouldCheck: false,
    categoryId: "no_clear_purpose",
    reasonKey: "flopTexture.mustCheck.sc.11.reason",
  },
];

function generateMustCheckScenario(): MustCheckScenario {
  const template =
    MUST_CHECK_SCENARIOS_DATA[Math.floor(Math.random() * MUST_CHECK_SCENARIOS_DATA.length)];
  const targetTexture =
    template.textureHint[Math.floor(Math.random() * template.textureHint.length)];
  const { ranks, suits } = generateFlopOfTexture(targetTexture);
...
function BoardCard({ rank, suit }: { rank: Rank; suit: Suit }) {
  return (
    <div className="flex h-20 w-14 flex-col items-center justify-center rounded-lg border-2 border-gray-200 bg-white shadow-lg sm:h-24 sm:w-16">
...
function FlopDisplay({ flop, suits }: { flop: Rank[]; suits: Suit[] }) {
  return (
    <div className="flex justify-center gap-2 rounded-xl bg-green-800/30 px-4 py-4 sm:gap-3 sm:px-8 sm:py-6">
      {flop.map((rank, i) => (
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="text-sm text-gray-400">
          {tCommon("accuracy")}:{" "}
          {score.total > 0 ? Math.round((score.correct / score.total) * 100) : 0}% ({score.correct}/
          {score.total})
        </div>
        ...
        <div className="space-y-4">
            ...
            {allTextures.map((cat) => {
              ...
              return (
                <Button
                  ...
                  variant="outline"
                  className={cn(
                    "h-11 justify-start px-2 text-left text-xs sm:h-auto sm:px-3 sm:py-3 sm:text-sm",
                    showResult &&
                      isCorrectAnswer &&
                ...
                >
                  ...
                  {showResult && isSelected && !isCorrectAnswer && (
                    <XCircle className="ml-auto h-3 w-3 shrink-0 sm:h-4 sm:w-4" />
                  )}
                </Button>
              );
            })}
                ...
                <div className="mt-3 flex flex-wrap items-center gap-4 text-sm">
                  <span className="text-gray-400">
                    ...
                    <span className="text-cyan-400">
                      {correctCategory.ip.cbetFreqMin}-{correctCategory.ip.cbetFreqMax}%
                    </span>
                  </span>
                  <span className="text-gray-400">
          ...
          {showResult && (
            <Button onClick={loadScenario} className="w-full">
              {t("flopTexture.next")} <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
          )}
        </div>
      )}
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-center gap-4 text-sm">
            <Badge variant="outline">
              {scenario.potType === "srp"
                ? t("flopTexture.srpBadge")
                : t("flopTexture.threeBpBadge")}
            </Badge>
            <Badge
              variant="outline"
              className={
          ...
          {/* Question */}
          <div className="text-center text-lg font-medium">{t("flopTexture.cbet.question")}</div>
              ...
              {FREQUENCY_OPTIONS.map((opt) => (
                <Button
                  ...
                  className={cn(
                    ...
                    showResult &&
                      selectedFreq === opt.key &&
                      opt.key !== scenario.correctFrequency &&
                      "ring-2 ring-red-400"
                  )}
              ...
              {SIZING_OPTIONS.map((opt) => (
                <Button
                  ...
                  className={cn(
                    ...
                    showResult &&
                      selectedSizing === opt.key &&
                      opt.key !== scenario.correctSizing &&
                      "ring-2 ring-red-400"
                  )}
          ...
          {showResult && (
            <Card className="border-gray-700 bg-gray-800/50">
              <CardContent className="pt-4">
                ...
                >
                  {isFreqCorrect && isSizingCorrect
                    ? t("flopTexture.cbet.allCorrect")
                    : isFreqCorrect || isSizingCorrect
                      ? t("flopTexture.cbet.partialCorrect")
                      : t("flopTexture.cbet.needsImprovement")}
                </div>
...
function QuickDrill() {
  ...
  const getQuestionText = () => {
    switch (scenario?.questionType) {
      case "connectivity":
        return t("flopTexture.quick.connectivity");
      case "suit_distribution":
        return t("flopTexture.quick.suitDistribution");
      case "texture_category":
        return t("flopTexture.quick.textureCategory");
      case "advantage_tier":
        return t("flopTexture.quick.advantageTier");
      default:
        return "";
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Progress
        ...
        className={cn(timeLeft <= 3 && "[&>div]:bg-red-500")}
      />
      ...
      {scenario && (
        <div className="space-y-4">
          ...
          {/* Question */}
          <div className="text-center text-lg font-medium">{getQuestionText()}</div>
          ...
          >
            {getOptions().map((opt) => {
              ...
              return (
                ...
                >
                  {opt.label}
                  {showResult && isCorrectAnswer && <CheckCircle2 className="ml-1 h-4 w-4" />}
                </Button>
              );
            })}
          </div>
...
const THREE_LAYER_LABELS: Record<
  ThreeLayerType,
  { questionKey: string; subtextKey: string; icon: string }
> = {
  initiative: {
...
const THREE_LAYER_OPTIONS: Record<
  ThreeLayerType,
  Array<{ key: string; labelKey: string; emoji: string }>
> = {
  initiative: [
...
function ThreeLayerDrill() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-cyan-700/50 bg-gradient-to-r from-cyan-900/30 to-blue-900/30 p-4">
        <h3 className="mb-2 text-sm font-semibold text-cyan-300">
          {t("flopTexture.threeLayer.frameworkTitle")}
        </h3>
        <div className="space-y-1 text-xs">
          <div
            className={cn(
              "flex items-center gap-2",
              layerType === "initiative" ? "font-semibold text-cyan-300" : "text-gray-400"
            )}
          >
          ...
          <div
            className={cn(
              "flex items-center gap-2",
              layerType === "volatility" ? "font-semibold text-cyan-300" : "text-gray-400"
            )}
          >
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-gray-700 text-[10px]">
              2
          ...
          <div
            className={cn(
              "flex items-center gap-2",
              layerType === "purpose" ? "font-semibold text-cyan-300" : "text-gray-400"
            )}
          >
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-gray-700 text-[10px]">
              3
      ...
      {scenario && layerLabel && (
        <div className="space-y-4">
          ...
          <div className="flex justify-center gap-6 text-sm text-gray-400">
            <div>
              Hero: <span className="text-cyan-400">{scenario.heroRange}</span>
            </div>
            <div>
              Villain: <span className="text-orange-400">{scenario.villainRange}</span>
            </div>
          </div>

          {/* Question */}
          <div className="text-center">
            <Badge className="mb-2 bg-cyan-600">Layer {layerLabel.icon}</Badge>
            <div className="text-lg font-medium">{t(layerLabel.questionKey)}</div>
            <div className="mt-1 text-sm text-gray-400">{t(layerLabel.subtextKey)}</div>
          </div>
          ...
          {showResult && (
            <Card className="border-gray-700 bg-gray-800/50">
              <CardContent className="pt-4">
                ...
                <p className="text-sm text-gray-300">{t(scenario.explanationKey)}</p>
              </CardContent>
            </Card>
          )}
...
function MustCheckDrill() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="rounded-lg border border-orange-700/50 bg-gradient-to-r from-orange-900/30 to-red-900/30 p-4">
        <h3 className="mb-2 text-sm font-semibold text-orange-300">
          {t("flopTexture.mustCheck.selfCheckTitle")}
        </h3>
        <p className="text-xs text-gray-400">{t("flopTexture.mustCheck.selfCheck")}</p>
        <p className="mt-1 text-xs text-orange-400">{t("flopTexture.mustCheck.selfCheckTip")}</p>
      </div>
      ...
      {scenario && (
        <div className="space-y-4">
          ...
          {/* Hero Hand */}
          <div className="text-center">
            <div className="mb-1 text-sm text-gray-400">{t("flopTexture.yourHand")}</div>
            ...
            <Card className="border-gray-700 bg-gray-800/50">
              <CardContent className="pt-4">
                ...
                <Badge variant="outline" className="mb-2">
                  {t(scenario.categoryNameKey)}
                </Badge>
                <p className="text-sm text-gray-300">{t(scenario.reasonKey)}</p>
              </CardContent>
            </Card>
          )}
...
function CheckFirstDrill() {
      ...
      <div className="space-y-6 text-center">
        <div className="py-8">
          ...
          <h2 className="mb-2 text-2xl font-bold text-green-400">
            {t("flopTexture.checkFirst.challengeSuccess")}
          </h2>
        ...
        <div className="rounded-lg border border-green-700/50 bg-gradient-to-r from-green-900/30 to-emerald-900/30 p-4">
          <p className="text-sm text-green-300">
            {t("flopTexture.checkFirst.muscleMemory")}
            <br />
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="rounded-lg border border-purple-700/50 bg-gradient-to-r from-purple-900/30 to-pink-900/30 p-4">
        <h3 className="mb-2 text-sm font-semibold text-purple-300">
          {t("flopTexture.checkFirst.title")}
        </h3>
        <p className="text-xs text-gray-400">
          {t("flopTexture.checkFirst.desc", { target: CHECK_FIRST_TARGET })}
        </p>
        <p className="mt-1 text-xs text-purple-400">{t("flopTexture.checkFirst.hintAllCheck")}</p>
      </div>
          ...
          {Array.from({ length: CHECK_FIRST_TARGET }).map((_, i) => (
            <div
              ...
              className={cn(
                ...
                i < streak ? "bg-gradient-to-r from-purple-500 to-pink-500" : "bg-gray-700"
              )}
            />
          ))}
        </div>
            ...
            <Button
              ...
              className={cn(
                ...
                showResult &&
                  ...
                  !isCorrect &&
                  "border-red-600 bg-red-600 text-white hover:bg-red-600",
                !showResult && "border-purple-500/50 hover:bg-purple-900/50"
              )}
              onClick={() => handleAnswer(true)}
              disabled={showResult}
            >
          ...
          {showResult && (
            ...
            >
              <CardContent className="pt-4">
                ...
                >
                  {isCorrect
                    ? t("flopTexture.checkFirst.correctStreak", { count: streak })
                    : t("flopTexture.checkFirst.wrongReset")}
                </div>
                <Badge variant="outline" className="mb-2">
                  {t(scenario.categoryNameKey)}
                </Badge>
...
function getFreqAdjustLabelKey(adj: FrequencyAdjust): { labelKey: string; color: string } {
  switch (adj) {
    case "much_higher":
      return { labelKey: "flopTexture.liveExploit.freqAdj.muchHigher", color: "text-green-400" };
    case "higher":
      return { labelKey: "flopTexture.liveExploit.freqAdj.higher", color: "text-green-300" };
    case "same":
      return { labelKey: "flopTexture.liveExploit.freqAdj.same", color: "text-gray-400" };
    case "lower":
      return { labelKey: "flopTexture.liveExploit.freqAdj.lower", color: "text-orange-300" };
    case "much_lower":
      return { labelKey: "flopTexture.liveExploit.freqAdj.muchLower", color: "text-red-400" };
  }
}
...
function getSizingAdjustLabelKey(adj: SizingAdjust): { labelKey: string; color: string } {
  switch (adj) {
    case "much_larger":
      return { labelKey: "flopTexture.liveExploit.sizingAdj.muchLarger", color: "text-green-400" };
    case "larger":
      return { labelKey: "flopTexture.liveExploit.sizingAdj.larger", color: "text-green-300" };
    case "same":
      return { labelKey: "flopTexture.liveExploit.sizingAdj.same", color: "text-gray-400" };
    case "smaller":
      return { labelKey: "flopTexture.liveExploit.sizingAdj.smaller", color: "text-orange-300" };
  }
}
...
const MULTIWAY_SCENARIOS = [
  {
    texture: "ABB" as FlopTextureType,
    handKey: "flopTexture.liveExploit.mwSc.0.hand",
    correctAction: "bet_large",
    explanationKey: "flopTexture.liveExploit.mwSc.0.explanation",
  },
  {
    texture: "ABB" as FlopTextureType,
    handKey: "flopTexture.liveExploit.mwSc.1.hand",
    correctAction: "check",
    explanationKey: "flopTexture.liveExploit.mwSc.1.explanation",
  },
  {
    texture: "Axx" as FlopTextureType,
    handKey: "flopTexture.liveExploit.mwSc.2.hand",
    correctAction: "bet_small",
    explanationKey: "flopTexture.liveExploit.mwSc.2.explanation",
  },
  {
    texture: "Axx" as FlopTextureType,
    handKey: "flopTexture.liveExploit.mwSc.3.hand",
    correctAction: "check",
    explanationKey: "flopTexture.liveExploit.mwSc.3.explanation",
  },
  {
    texture: "BBB" as FlopTextureType,
    handKey: "flopTexture.liveExploit.mwSc.4.hand",
    correctAction: "bet_large",
    explanationKey: "flopTexture.liveExploit.mwSc.4.explanation",
  },
  {
    texture: "BBB" as FlopTextureType,
    handKey: "flopTexture.liveExploit.mwSc.5.hand",
    correctAction: "check",
    explanationKey: "flopTexture.liveExploit.mwSc.5.explanation",
  },
  {
    texture: "Low_conn" as FlopTextureType,
    handKey: "flopTexture.liveExploit.mwSc.6.hand",
    correctAction: "bet_small",
    explanationKey: "flopTexture.liveExploit.mwSc.6.explanation",
  },
  {
    texture: "Low_conn" as FlopTextureType,
    handKey: "flopTexture.liveExploit.mwSc.7.hand",
    correctAction: "check",
    explanationKey: "flopTexture.liveExploit.mwSc.7.explanation",
  },
  {
    texture: "JT_conn" as FlopTextureType,
    handKey: "flopTexture.liveExploit.mwSc.8.hand",
    correctAction: "bet_large",
    explanationKey: "flopTexture.liveExploit.mwSc.8.explanation",
  },
  {
    texture: "JT_conn" as FlopTextureType,
    handKey: "flopTexture.liveExploit.mwSc.9.hand",
    correctAction: "check",
    explanationKey: "flopTexture.liveExploit.mwSc.9.explanation",
  },
  {
    texture: "Paired" as FlopTextureType,
    handKey: "flopTexture.liveExploit.mwSc.10.hand",
    correctAction: "bet_small",
    explanationKey: "flopTexture.liveExploit.mwSc.10.explanation",
  },
  {
    texture: "Paired" as FlopTextureType,
    handKey: "flopTexture.liveExploit.mwSc.11.hand",
    correctAction: "check",
    explanationKey: "flopTexture.liveExploit.mwSc.11.explanation",
  },
];
...
const DANGER_SIGN_SCENARIOS = [
  {
    texture: "ABB" as FlopTextureType,
    actionKey: "flopTexture.liveExploit.dsSc.0.action",
    correctMeaning: "strong",
    explanationKey: "flopTexture.liveExploit.dsSc.0.explanation",
  },
  {
    texture: "ABB" as FlopTextureType,
    actionKey: "flopTexture.liveExploit.dsSc.1.action",
    correctMeaning: "nuts",
    explanationKey: "flopTexture.liveExploit.dsSc.1.explanation",
  },
  {
    texture: "Axx" as FlopTextureType,
    actionKey: "flopTexture.liveExploit.dsSc.2.action",
    correctMeaning: "strong",
    explanationKey: "flopTexture.liveExploit.dsSc.2.explanation",
  },
  {
    texture: "BBx" as FlopTextureType,
    actionKey: "flopTexture.liveExploit.dsSc.3.action",
    correctMeaning: "strong",
    explanationKey: "flopTexture.liveExploit.dsSc.3.explanation",
  },
  {
    texture: "Low_conn" as FlopTextureType,
    actionKey: "flopTexture.liveExploit.dsSc.4.action",
    correctMeaning: "weak_value",
    explanationKey: "flopTexture.liveExploit.dsSc.4.explanation",
  },
  {
    texture: "Low_conn" as FlopTextureType,
    actionKey: "flopTexture.liveExploit.dsSc.5.action",
    correctMeaning: "nuts",
    explanationKey: "flopTexture.liveExploit.dsSc.5.explanation",
  },
  {
    texture: "JTx" as FlopTextureType,
    actionKey: "flopTexture.liveExploit.dsSc.6.action",
    correctMeaning: "nuts",
    explanationKey: "flopTexture.liveExploit.dsSc.6.explanation",
  },
  {
    texture: "Paired" as FlopTextureType,
    actionKey: "flopTexture.liveExploit.dsSc.7.action",
    correctMeaning: "strong",
    explanationKey: "flopTexture.liveExploit.dsSc.7.explanation",
  },
  {
    texture: "Trips" as FlopTextureType,
    actionKey: "flopTexture.liveExploit.dsSc.8.action",
    correctMeaning: "drawing",
    explanationKey: "flopTexture.liveExploit.dsSc.8.explanation",
  },
  {
    texture: "BBB" as FlopTextureType,
    actionKey: "flopTexture.liveExploit.dsSc.9.action",
    correctMeaning: "polarized",
    explanationKey: "flopTexture.liveExploit.dsSc.9.explanation",
  },
];
...
const LEAK_EXPLOIT_SCENARIOS = [
  {
    texture: "ABB" as FlopTextureType,
    leakKey: "flopTexture.liveExploit.leSc.0.leak",
    correctExploit: "raise",
    explanationKey: "flopTexture.liveExploit.leSc.0.explanation",
  },
  {
    texture: "Axx" as FlopTextureType,
    leakKey: "flopTexture.liveExploit.leSc.1.leak",
    correctExploit: "fold_marginal",
    explanationKey: "flopTexture.liveExploit.leSc.1.explanation",
  },
  {
    texture: "Low_conn" as FlopTextureType,
    leakKey: "flopTexture.liveExploit.leSc.2.leak",
    correctExploit: "bet_thin",
    explanationKey: "flopTexture.liveExploit.leSc.2.explanation",
  },
  {
    texture: "BBx" as FlopTextureType,
    leakKey: "flopTexture.liveExploit.leSc.3.leak",
    correctExploit: "value_bet",
    explanationKey: "flopTexture.liveExploit.leSc.3.explanation",
  },
  {
    texture: "JT_conn" as FlopTextureType,
    leakKey: "flopTexture.liveExploit.leSc.4.leak",
    correctExploit: "value_only",
    explanationKey: "flopTexture.liveExploit.leSc.4.explanation",
  },
  {
    texture: "Paired" as FlopTextureType,
    leakKey: "flopTexture.liveExploit.leSc.5.leak",
    correctExploit: "call_light",
    explanationKey: "flopTexture.liveExploit.leSc.5.explanation",
  },
  {
    texture: "Trips" as FlopTextureType,
    leakKey: "flopTexture.liveExploit.leSc.6.leak",
    correctExploit: "overbet_value",
    explanationKey: "flopTexture.liveExploit.leSc.6.explanation",
  },
  {
    texture: "ABx" as FlopTextureType,
    leakKey: "flopTexture.liveExploit.leSc.7.leak",
    correctExploit: "cr_bluff",
    explanationKey: "flopTexture.liveExploit.leSc.7.explanation",
  },
];
        ...
        {selected && (
          <Card className="border-amber-700/50 bg-gray-900/50">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="rounded bg-gray-800/50 p-3">
                  <div className="mb-1 text-xs text-gray-500">
                    {t("flopTexture.liveExploit.gtoFreq")}
                  </div>
                  <div className="text-cyan-400">
                    {selected.ip.cbetFreqMin}-{selected.ip.cbetFreqMax}%
                  </div>
                </div>
                <div className="rounded bg-gray-800/50 p-3">
                  <div className="mb-1 text-xs text-gray-500">
                    {t("flopTexture.liveExploit.liveAdjust")}
                  </div>
                  <div
                    className={getFreqAdjustLabelKey(selected.liveExploit.frequencyAdjust).color}
                  >
                ...
                <div className="rounded bg-gray-800/50 p-3">
                  <div className="mb-1 text-xs text-gray-500">
                    {t("flopTexture.liveExploit.gtoSizing")}
                  </div>
              ...
              {/* Multi-way note */}
              <div className="rounded border border-orange-700/30 bg-orange-900/20 p-3">
                <div className="mb-1 text-xs font-semibold text-orange-400">
                  🎯 {t("flopTexture.liveExploit.multiwayNote")}
                </div>
              ...
              <div className="rounded border border-green-700/30 bg-green-900/20 p-3">
                <div className="mb-1 text-xs font-semibold text-green-400">
                  💡 {t("flopTexture.liveExploit.exploitTip")}
                </div>
              ...
              <div>
                <div className="mb-2 text-xs text-gray-500">
                  {t("flopTexture.liveExploit.opponentLeaks")}
                </div>
              ...
              <div className="rounded border border-red-700/30 bg-red-900/20 p-3">
                <div className="mb-1 text-xs font-semibold text-red-400">
                  ⚠️ {t("flopTexture.liveExploit.dangerSigns")}
                </div>
      ...
      {quiz && quizCategory && (
        <div className="space-y-4">
          ...
          {quiz.type === "adjustment" && (
            <>
              <div className="rounded bg-gray-800/50 p-3 text-center text-sm">
                <span className="text-gray-400">{t("flopTexture.liveExploit.gtoBasis")}</span>
                <span className="text-cyan-400">
                  {quizCategory.ip.cbetFreqMin}-{quizCategory.ip.cbetFreqMax}%
                </span>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-2 sm:grid-cols-5">
                  {(
                    ["much_higher", "higher", "same", "lower", "much_lower"] as FrequencyAdjust[]
                  ).map((opt) => {
                    ...
                    return (
                      <Button
                        ...
                        className={cn(
                          "h-auto py-2 text-xs",
                          showQuizResult &&
                            opt === quizCategory.liveExploit.frequencyAdjust &&
                            "ring-2 ring-green-400",
                          showQuizResult &&
                            quiz.adjustmentAnswer?.freq === opt &&
                            opt !== quizCategory.liveExploit.frequencyAdjust &&
                            "ring-2 ring-red-400"
                        )}
                        onClick={() =>
                          ...
                          setQuiz((prev) =>
                            prev
                              ? {
                                  ...prev,
                                  adjustmentAnswer: { ...prev.adjustmentAnswer!, freq: opt },
                                }
                              : null
                          )
                        }
              ...
              <div className="space-y-2">
                <p className="text-sm text-gray-400">
                  {t("flopTexture.liveExploit.sizingAdjLabel")}
                </p>
                    ...
                    return (
                      <Button
                        ...
                        className={cn(
                          "h-auto py-2 text-xs",
                          showQuizResult &&
                            opt === quizCategory.liveExploit.sizingAdjust &&
                            "ring-2 ring-green-400",
                          showQuizResult &&
                            quiz.adjustmentAnswer?.sizing === opt &&
                            opt !== quizCategory.liveExploit.sizingAdjust &&
                            "ring-2 ring-red-400"
                        )}
                        onClick={() =>
                          ...
                          setQuiz((prev) =>
                            prev
                              ? {
                                  ...prev,
                                  adjustmentAnswer: { ...prev.adjustmentAnswer!, sizing: opt },
                                }
                              : null
                          )
                        }
                ...
                <Card className="border-gray-700 bg-gray-800/50">
                  <CardContent className="pt-4">
                    ...
                    >
                      ...
                      quiz.adjustmentAnswer?.sizing === quizCategory.liveExploit.sizingAdjust
                        ? t("flopTexture.cbet.allCorrect")
                        : t("flopTexture.liveExploit.needsAdjust")}
                    </div>
                    <p className="mb-2 text-sm text-gray-300">
                      {t("flopTexture.liveExploit.correctAns", {
                        freq: t(
                          getFreqAdjustLabelKey(quizCategory.liveExploit.frequencyAdjust).labelKey
                        ),
                        sizing: t(
                          getSizingAdjustLabelKey(quizCategory.liveExploit.sizingAdjust).labelKey
                        ),
                      })}
                    </p>
          ...
          {quiz.type === "multiway" && quiz.multiwayScenario && (
            <>
              <div className="rounded border border-orange-700/30 bg-orange-900/20 p-3 text-center">
                <p className="mb-1 text-sm font-medium text-orange-400">
                  {t("flopTexture.liveExploit.multiway.title")}
                </p>
                <p className="text-white">
                  {t("flopTexture.liveExploit.multiway.yourHand", {
                    hand: t(quiz.multiwayScenario.handKey),
                  })}
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  {
                    value: "check",
                    labelKey: "flopTexture.liveExploit.multiway.check",
                    icon: "✋",
                  },
                  {
                    value: "bet_small",
                    labelKey: "flopTexture.liveExploit.multiway.betSmall",
                    icon: "💰",
                  },
                  {
                    value: "bet_large",
                    labelKey: "flopTexture.liveExploit.multiway.betLarge",
                    icon: "💎",
                  },
                  ...
                  <Button
                    ...
                    className={cn(
                      "h-auto py-3",
                      showQuizResult &&
                        opt.value === quiz.multiwayScenario?.correctAction &&
                        "ring-2 ring-green-400",
                      showQuizResult &&
                        quiz.multiwayAnswer === opt.value &&
                        opt.value !== quiz.multiwayScenario?.correctAction &&
                        "ring-2 ring-red-400"
                    )}
                    onClick={() =>
                      !showQuizResult &&
                      setQuiz((prev) => (prev ? { ...prev, multiwayAnswer: opt.value } : null))
                    }
                    disabled={showQuizResult}
                  >
                ...
                <Card className="border-gray-700 bg-gray-800/50">
                  <CardContent className="pt-4">
                    <div
                      className={cn(
                        "mb-2 text-lg font-semibold",
                        quiz.multiwayAnswer === quiz.multiwayScenario.correctAction
                          ? "text-green-400"
                          : "text-orange-400"
                      )}
                    >
                      {quiz.multiwayAnswer === quiz.multiwayScenario.correctAction
                        ? t("result.correct")
                        : t("flopTexture.liveExploit.notCorrect")}
                    </div>
                    <p className="text-sm text-gray-300">
                      {t(quiz.multiwayScenario.explanationKey)}
                    </p>
                  </CardContent>
                </Card>
              )}
          ...
          {quiz.type === "dangerSign" && quiz.dangerScenario && (
            <>
              <div className="rounded border border-red-700/30 bg-red-900/20 p-3 text-center">
                <p className="mb-1 text-sm font-medium text-red-400">
                  {t("flopTexture.liveExploit.dangerSign.opponentAction")}
                </p>
                <p className="text-sm text-white">{t(quiz.dangerScenario.actionKey)}</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  {
                    value: "weak_value",
                    labelKey: "flopTexture.liveExploit.dangerSign.weakValue",
                    color: "text-yellow-400",
                  },
                  {
                    value: "drawing",
                    labelKey: "flopTexture.liveExploit.dangerSign.drawing",
                    color: "text-blue-400",
                  },
                  {
                    value: "strong",
                    labelKey: "flopTexture.liveExploit.dangerSign.strong",
                    color: "text-orange-400",
                  },
                  {
                    value: "nuts",
                    labelKey: "flopTexture.liveExploit.dangerSign.nuts",
                    color: "text-red-400",
                  },
                  {
                    value: "polarized",
                    labelKey: "flopTexture.liveExploit.dangerSign.polarized",
                  ...
                  <Button
                    ...
                    className={cn(
                      "h-auto py-3 text-sm",
                      showQuizResult &&
                        opt.value === quiz.dangerScenario?.correctMeaning &&
                        "ring-2 ring-green-400",
                      showQuizResult &&
                        quiz.dangerAnswer === opt.value &&
                        opt.value !== quiz.dangerScenario?.correctMeaning &&
                        "ring-2 ring-red-400"
                    )}
                    onClick={() =>
                      !showQuizResult &&
                      setQuiz((prev) => (prev ? { ...prev, dangerAnswer: opt.value } : null))
                    }
                    disabled={showQuizResult}
                  >
                    {t(opt.labelKey)}
                ...
                <Card className="border-gray-700 bg-gray-800/50">
                  <CardContent className="pt-4">
                    <div
                      className={cn(
                        "mb-2 text-lg font-semibold",
                        quiz.dangerAnswer === quiz.dangerScenario.correctMeaning
                          ? "text-green-400"
                          : "text-orange-400"
                      )}
                    >
          ...
          {quiz.type === "leakExploit" && quiz.leakScenario && (
            <>
              <div className="rounded border border-green-700/30 bg-green-900/20 p-3 text-center">
                <p className="mb-1 text-sm font-medium text-green-400">
                  {t("flopTexture.liveExploit.leakExploitQ.opponentLeak")}
                </p>
                <p className="text-sm text-white">{t(quiz.leakScenario.leakKey)}</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  {
                    value: "raise",
                    labelKey: "flopTexture.liveExploit.leakExploitQ.raise",
                    icon: "⬆️",
                  },
                  {
                    value: "call_light",
                    labelKey: "flopTexture.liveExploit.leakExploitQ.callLight",
                    icon: "📞",
                  },
                  {
                    value: "value_bet",
                    labelKey: "flopTexture.liveExploit.leakExploitQ.valueBet",
                    icon: "💵",
                  },
                  {
                    value: "value_only",
                    labelKey: "flopTexture.liveExploit.leakExploitQ.valueOnly",
                    icon: "✅",
                  },
                  {
                    value: "overbet_value",
                    labelKey: "flopTexture.liveExploit.leakExploitQ.overbetValue",
                    icon: "💰",
                  },
                  {
                    value: "cr_bluff",
                    labelKey: "flopTexture.liveExploit.leakExploitQ.crBluff",
                    icon: "🃏",
                  },
                  {
                    value: "fold_marginal",
                    labelKey: "flopTexture.liveExploit.leakExploitQ.foldMarginal",
                    icon: "🏳️",
                  },
                  {
                    value: "bet_thin",
                    labelKey: "flopTexture.liveExploit.leakExploitQ.betThin",
                    icon: "📉",
                  },
                ].map((opt) => (
                  <Button
                    ...
                    className={cn(
                      "h-auto py-2 text-xs",
                      showQuizResult &&
                        opt.value === quiz.leakScenario?.correctExploit &&
                        "ring-2 ring-green-400",
                      showQuizResult &&
                        quiz.leakAnswer === opt.value &&
                        opt.value !== quiz.leakScenario?.correctExploit &&
                        "ring-2 ring-red-400"
                    )}
                    onClick={() =>
                      !showQuizResult &&
                      setQuiz((prev) => (prev ? { ...prev, leakAnswer: opt.value } : null))
                    }
                    disabled={showQuizResult}
                  >
                    {opt.icon} {t(opt.labelKey)}
                ...
                <Card className="border-gray-700 bg-gray-800/50">
                  <CardContent className="pt-4">
                    <div
                      className={cn(
                        "mb-2 text-lg font-semibold",
                        quiz.leakAnswer === quiz.leakScenario.correctExploit
                          ? "text-green-400"
                          : "text-orange-400"
                      )}
                    >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-950 text-white">
      <div className="container mx-auto max-w-3xl px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="mb-2 text-2xl font-bold sm:text-3xl">{t("flopTexture.title")}</h1>
          <p className="text-gray-400">{t("flopTexture.description")}</p>
        </div>

        {/* Mode Tabs */}
        <Tabs value={mode} onValueChange={(v) => setMode(v as DrillMode)} className="space-y-6">
          <TabsList className="grid h-auto w-full grid-cols-4 bg-gray-800 sm:grid-cols-7">
            <TabsTrigger
              value="checkfirst"
              className="text-[10px] data-[state=active]:bg-purple-600 sm:text-sm"
            >
              🔥{t("flopTexture.tabs.checkFirst")}
            </TabsTrigger>
            <TabsTrigger value="threelayer" className="text-[10px] sm:text-sm">
              {t("flopTexture.tabs.threeLayer")}
            </TabsTrigger>
            <TabsTrigger value="mustcheck" className="text-[10px] sm:text-sm">
              {t("flopTexture.tabs.mustCheck")}
            </TabsTrigger>
            <TabsTrigger
              value="liveexploit"
              className="text-[10px] data-[state=active]:bg-amber-600 sm:text-sm"
            >
              📍{t("flopTexture.tabs.liveExploit")}
            </TabsTrigger>
            <TabsTrigger value="classify" className="text-[10px] sm:text-sm">
              {t("flopTexture.tabs.classify")}
            </TabsTrigger>
            <TabsTrigger value="cbet" className="text-[10px] sm:text-sm">
              {t("flopTexture.tabs.cbet")}
            </TabsTrigger>
            <TabsTrigger value="quick" className="text-[10px] sm:text-sm">
              {t("flopTexture.tabs.quick")}
            </TabsTrigger>
          </TabsList>

          <TabsContent value="checkfirst">
            <Card className="border-purple-700/50 bg-gray-800/50">
              <CardHeader>
                <CardTitle className="text-lg">
                  🔥 {t("flopTexture.checkFirst.cardTitle")}
                </CardTitle>
          ...
          <TabsContent value="liveexploit">
            <Card className="border-amber-700/50 bg-gray-800/50">
              <CardHeader>
                <CardTitle className="text-lg">
                  📍 {t("flopTexture.liveExploit.cardTitle")}
                </CardTitle>
        ...
        {/* Texture Reference */}
        <Card className="mt-8 border-gray-700 bg-gray-800/50">
          <CardHeader>
          ...
          <CardContent>
            <div className="grid grid-cols-1 gap-2 text-sm">
              {Object.values(FLOP_TEXTURE_CATEGORIES).map((cat) => (
                <div
                  key={cat.id}
                  className="flex items-center justify-between gap-2 rounded bg-gray-900/50 p-2"
                >
                  <div className="flex min-w-0 items-center gap-2">
                    <Badge
                      className={cn("shrink-0 text-[10px]", getAdvantageColor(cat.advantageTier))}
                    >
                      {cat.advantageTier}
                    </Badge>
                  ...
                  <div className="flex shrink-0 gap-3 text-xs">
                    ...
                    <span className="text-cyan-400">
                      {cat.ip.cbetFreqMin}-{cat.ip.cbetFreqMax}%
                    </span>
