...
describe("evaluateHand", () => {
  describe("hand ranking identification", () => {
    it("should identify royal flush", () => {
      ...
      const community = [card("Q", "h"), card("J", "h"), card("T", "h"), card("2", "d"), card("3", "c")];
    ...
    it("should identify straight flush", () => {
      ...
      const community = [card("7", "h"), card("6", "h"), card("5", "h"), card("2", "d"), card("3", "c")];
      const result = evaluateHand(holeCards, community);
    ...
    it("should identify four of a kind", () => {
      ...
      const community = [card("A", "d"), card("A", "c"), card("K", "h"), card("2", "d"), card("3", "c")];
      const result = evaluateHand(holeCards, community);
    ...
    it("should identify full house", () => {
      ...
      const community = [card("K", "d"), card("Q", "c"), card("Q", "h"), card("2", "d"), card("3", "c")];
      const result = evaluateHand(holeCards, community);
    ...
    it("should identify flush", () => {
      const holeCards: [Card, Card] = [card("A", "h"), card("K", "h")];
      const community = [card("9", "h"), card("7", "h"), card("2", "h"), card("3", "d"), card("4", "c")];
      const result = evaluateHand(holeCards, community);
    ...
    it("should identify straight", () => {
      ...
      const community = [card("7", "d"), card("6", "c"), card("5", "h"), card("2", "d"), card("K", "c")];
      const result = evaluateHand(holeCards, community);
    ...
    it("should identify wheel (A-2-3-4-5)", () => {
      ...
      const community = [card("3", "d"), card("4", "c"), card("5", "h"), card("K", "d"), card("Q", "c")];
      const result = evaluateHand(holeCards, community);
      expect(result.rank).toBe("straight");
    });
    ...
    it("should identify three of a kind", () => {
      const holeCards: [Card, Card] = [card("K", "h"), card("K", "s")];
      const community = [card("K", "d"), card("7", "c"), card("2", "h"), card("3", "d"), card("9", "c")];
      const result = evaluateHand(holeCards, community);
    ...
    it("should identify two pair", () => {
      ...
      const community = [card("K", "d"), card("Q", "c"), card("2", "h"), card("3", "d"), card("9", "c")];
      const result = evaluateHand(holeCards, community);
    ...
    it("should identify one pair", () => {
      ...
      const community = [card("A", "d"), card("7", "c"), card("2", "h"), card("3", "d"), card("9", "c")];
      const result = evaluateHand(holeCards, community);
    ...
    it("should identify high card", () => {
      const holeCards: [Card, Card] = [card("A", "h"), card("K", "s")];
      const community = [card("Q", "d"), card("7", "c"), card("2", "h"), card("3", "d"), card("9", "c")];
      const result = evaluateHand(holeCards, community);
  ...
  describe("hand comparison", () => {
    it("should rank flush higher than straight", () => {
      ...
      const community = [card("9", "h"), card("7", "h"), card("2", "h"), card("6", "d"), card("5", "c")];
    ...
    it("should compare same rank by kickers", () => {
      ...
      const community = [card("A", "c"), card("7", "h"), card("2", "d"), card("3", "s"), card("9", "h")];
...
describe("determineWinners", () => {
  it("should find single winner", () => {
    ...
    const community = [card("2", "d"), card("3", "c"), card("7", "h"), card("9", "d"), card("J", "c")];
  ...
  it("should handle split pot (tie)", () => {
    ...
    const community = [card("T", "h"), card("J", "c"), card("Q", "d"), card("K", "s"), card("A", "c")];
