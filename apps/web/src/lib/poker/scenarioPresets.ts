...
export const SCENARIO_PRESETS: ScenarioPreset[] = [
  ...
  // ========================================
  {
    ...
    effectiveStack: 100,
    preflopActions: [
      { playerId: "player_2", playerName: "Hero", position: "BTN", action: "raise", amount: 2.5, street: "preflop", timestamp: 0, isHero: true },
      { playerId: "player_0", playerName: "AI_BB", position: "BB", action: "call", amount: 2.5, street: "preflop", timestamp: 1, isHero: false },
    ],
  ...
  },
  {
    ...
    effectiveStack: 100,
    preflopActions: [
      { playerId: "player_2", playerName: "AI_BTN", position: "BTN", action: "raise", amount: 2.5, street: "preflop", timestamp: 0, isHero: false },
      { playerId: "player_0", playerName: "Hero", position: "BB", action: "call", amount: 2.5, street: "preflop", timestamp: 1, isHero: true },
    ],
  ...
  },
  {
    ...
    effectiveStack: 100,
    preflopActions: [
      { playerId: "player_3", playerName: "Hero", position: "CO", action: "raise", amount: 2.3, street: "preflop", timestamp: 0, isHero: true },
      { playerId: "player_0", playerName: "AI_BB", position: "BB", action: "call", amount: 2.3, street: "preflop", timestamp: 1, isHero: false },
    ],
  ...
  // ========================================
  {
    ...
    preflopActions: [
      { playerId: "player_2", playerName: "Hero", position: "BTN", action: "raise", amount: 2.5, street: "preflop", timestamp: 0, isHero: true },
      { playerId: "player_0", playerName: "AI_BB", position: "BB", action: "raise", amount: 9, street: "preflop", timestamp: 1, isHero: false },
      { playerId: "player_2", playerName: "Hero", position: "BTN", action: "call", amount: 9, street: "preflop", timestamp: 2, isHero: true },
    ],
  ...
  },
  {
    ...
    effectiveStack: 100,
    preflopActions: [
      { playerId: "player_3", playerName: "AI_CO", position: "CO", action: "raise", amount: 2.3, street: "preflop", timestamp: 0, isHero: false },
      { playerId: "player_0", playerName: "Hero", position: "BB", action: "raise", amount: 8, street: "preflop", timestamp: 1, isHero: true },
      { playerId: "player_3", playerName: "AI_CO", position: "CO", action: "call", amount: 8, street: "preflop", timestamp: 2, isHero: false },
    ],
  ...
  },
  {
    ...
    preflopActions: [
      { playerId: "player_2", playerName: "AI_BTN", position: "BTN", action: "raise", amount: 2.5, street: "preflop", timestamp: 0, isHero: false },
      { playerId: "player_1", playerName: "Hero", position: "SB", action: "raise", amount: 10, street: "preflop", timestamp: 1, isHero: true },
      { playerId: "player_2", playerName: "AI_BTN", position: "BTN", action: "call", amount: 10, street: "preflop", timestamp: 2, isHero: false },
    ],
  ...
  // ========================================
  {
    ...
    preflopActions: [
      { playerId: "player_2", playerName: "Hero", position: "BTN", action: "raise", amount: 2.5, street: "preflop", timestamp: 0, isHero: true },
      { playerId: "player_0", playerName: "AI_BB", position: "BB", action: "raise", amount: 9, street: "preflop", timestamp: 1, isHero: false },
      { playerId: "player_2", playerName: "Hero", position: "BTN", action: "raise", amount: 22, street: "preflop", timestamp: 2, isHero: true },
      { playerId: "player_0", playerName: "AI_BB", position: "BB", action: "call", amount: 22, street: "preflop", timestamp: 3, isHero: false },
    ],
  ...
  // ========================================
  {
    ...
    preflopActions: [
      { playerId: "player_2", playerName: "Hero", position: "BTN", action: "raise", amount: 2.5, street: "preflop", timestamp: 0, isHero: true },
      { playerId: "player_3", playerName: "AI_CO", position: "CO", action: "call", amount: 2.5, street: "preflop", timestamp: 1, isHero: false },
      { playerId: "player_0", playerName: "AI_BB", position: "BB", action: "call", amount: 2.5, street: "preflop", timestamp: 2, isHero: false },
    ],
  ...
  },
  {
    ...
    effectiveStack: 100,
    preflopActions: [
      { playerId: "player_5", playerName: "AI_UTG", position: "UTG", action: "raise", amount: 2.2, street: "preflop", timestamp: 0, isHero: false },
      { playerId: "player_2", playerName: "AI_BTN", position: "BTN", action: "call", amount: 2.2, street: "preflop", timestamp: 1, isHero: false },
      { playerId: "player_0", playerName: "Hero", position: "BB", action: "call", amount: 2.2, street: "preflop", timestamp: 2, isHero: true },
    ],
  ...
  // ========================================
  {
    ...
    description: "UTG opens, MP calls, BTN squeezes",
    descriptionZh: "槍口位加注，中位跟注，按鈕位squeeze",
    category: "squeeze",
    heroPosition: "BTN",
    numPlayers: 3,
    effectiveStack: 100,
    preflopActions: [
      { playerId: "player_5", playerName: "AI_UTG", position: "UTG", action: "raise", amount: 2.2, street: "preflop", timestamp: 0, isHero: false },
      { playerId: "player_4", playerName: "AI_MP", position: "MP", action: "call", amount: 2.2, street: "preflop", timestamp: 1, isHero: false },
    ],
  ...
  // ========================================
  {
    ...
    effectiveStack: 150,
    preflopActions: [
      { playerId: "player_2", playerName: "Hero", position: "BTN", action: "raise", amount: 3, street: "preflop", timestamp: 0, isHero: true },
      { playerId: "player_0", playerName: "AI_BB", position: "BB", action: "call", amount: 3, street: "preflop", timestamp: 1, isHero: false },
    ],
...
export const SCENARIO_CATEGORIES: Array<{
  ...
  { id: "3bet_pot", name: "3-Bet Pots", nameZh: "3-Bet 底池", description: "Playing in 3-bet pots" },
  { id: "4bet_pot", name: "4-Bet Pots", nameZh: "4-Bet 底池", description: "Playing in 4-bet pots" },
