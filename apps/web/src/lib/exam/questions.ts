...
export const EXAM_QUESTIONS: ExamQuestion[] = [
  ...
  // ========== 新增 Texture 質地題目 ==========
  {
    id: "tx1",
    type: "postflop",
    question: "A♠K♦7♣ 這個翻牌屬於 Gareth James 12 型分類的哪一種？",
    options: [
      { key: "a", text: "ABB (A + 2 Broadway)" },
      { key: "b", text: "ABx (A + 1 Broadway + low)" },
      { key: "c", text: "Axx (A + 2 low cards)" },
  ...
  },
  {
    id: "tx2",
    type: "postflop",
    question: "Q♠J♦T♣ 這個翻牌對誰最有利？",
    options: [
      { key: "a", text: "開牌者（範圍優勢）" },
      { key: "b", text: "跟注者（範圍更匹配）" },
      { key: "c", text: "兩者差不多" },
      { key: "d", text: "位置較後的玩家" },
    ],
    correctAnswer: "a",
  ...
  },
  {
    id: "tx3",
    type: "postflop",
    question: "8♠7♠5♦ 這個翻牌屬於哪種質地？",
    options: [
      { key: "a", text: "Low_conn（低牌連接）" },
      { key: "b", text: "Low_unconn（低牌不連接）" },
      { key: "c", text: "JT_conn" },
      { key: "d", text: "BBx" },
    ],
    correctAnswer: "a",
  ...
  },
  {
    id: "tx4",
    type: "postflop",
    question: "在 Paired 配對牌面（如 K♠K♦7♣），C-bet 策略應該如何？",
    options: [
      { key: "a", text: "高頻小注（25-33%）" },
      { key: "b", text: "低頻大注（75%+）" },
      { key: "c", text: "極化策略（check 或大注）" },
      { key: "d", text: "不應該 C-bet" },
    ],
    correctAnswer: "a",
    explanation: "配對牌面對開牌者有利（更多強 overpair），且對手很難有 Kx，適合高頻小注施壓。",
  },
  {
    id: "tx5",
    type: "postflop",
    question: "K♠7♦3♣ 這個翻牌是哪種質地？",
    options: [
      { key: "a", text: "Axx" },
      { key: "b", text: "KQx（K/Q 高 + 2 low）" },
      { key: "c", text: "BBx" },
  ...
  },
  {
    id: "tx6",
    type: "postflop",
    question: "J♠9♦7♣ 這個翻牌對開牌者的 C-bet 頻率應該如何？",
    options: [
      { key: "a", text: "高頻（80%+）- 開牌者有範圍優勢" },
      { key: "b", text: "中等（50-60%）- 連接牌面，需謹慎" },
      { key: "c", text: "低頻（30-40%）- 跟注者範圍更匹配" },
      { key: "d", text: "極低（<20%）" },
    ],
    correctAnswer: "b",
    explanation:
  ...
  },
  {
    id: "tx7",
    type: "postflop",
    question: "在 Trips 三條牌面（如 7♠7♦7♣），最佳策略是？",
    options: [
      { key: "a", text: "高頻小注 - 因為對手幾乎不可能有第四張 7" },
      { key: "b", text: "總是 check" },
      { key: "c", text: "極化大注" },
      { key: "d", text: "放棄底池" },
    ],
    correctAnswer: "a",
    explanation: "Trips 牌面雙方都很難有三條，開牌者的高對有絕對優勢，適合高頻小注取值。",
  },
  {
    id: "tx8",
    type: "postflop",
    question: "什麼是「連接度」（connectedness）在質地分類中的作用？",
    options: [
      { key: "a", text: "決定牌面是否容易完成順子，影響 C-bet 策略" },
      { key: "b", text: "決定花色分布" },
      { key: "c", text: "決定最高牌的點數" },
      { key: "d", text: "只影響河牌策略" },
    ],
  ...
  },
  {
    id: "tx9",
    type: "postflop",
    question: "A♠8♦3♣ 這個翻牌應該用什麼 C-bet sizing？",
    options: [
      { key: "a", text: "小注（25-33%）- 乾燥 A 高面" },
      { key: "b", text: "中注（50%）" },
      { key: "c", text: "大注（75%+）" },
      { key: "d", text: "Overbet（100%+）" },
    ],
    correctAnswer: "a",
    explanation: "A83r 是 Axx（A + 2 low cards），非常乾燥，開牌者範圍優勢明顯，小注高頻最有效。",
  },
  {
    id: "tx10",
    type: "postflop",
    question: "為什麼 monotone（單花面）會降低 C-bet 頻率？",
    options: [
      { key: "a", text: "對手的同花聽牌和已完成同花很多，棄牌率下降" },
      { key: "b", text: "因為你可能有同花" },
      { key: "c", text: "因為牌面太濕潤" },
      { key: "d", text: "因為需要更大的注" },
    ],
  ...
  },
  {
    id: "tx11",
    type: "postflop",
    question: "Q♠T♦8♣ 和 Q♠7♦3♣ 哪個對開牌者更有利？",
    options: [
      { key: "a", text: "Q73 - 更乾燥，範圍優勢更明顯" },
      { key: "b", text: "QT8 - 高牌更多" },
      { key: "c", text: "差不多" },
      { key: "d", text: "取決於花色" },
    ],
  ...
  },
  {
    id: "tx12",
    type: "postflop",
    question: "在 BBx（2 Broadway + 1 low）牌面如 K♠Q♦5♣，IP 的 C-bet 頻率應該？",
    options: [
      { key: "a", text: "高頻（75-85%）" },
      { key: "b", text: "中頻（50-60%）" },
      { key: "c", text: "低頻（30-40%）" },
  ...
  },
  {
    id: "tx13",
    type: "postflop",
    question: "什麼情況下「advantage tier」會是 high？",
    options: [
      { key: "a", text: "ABB, ABx, BBB, BBx - 多 Broadway 的乾燥牌面" },
      { key: "b", text: "Low_conn, JT_conn - 連接牌面" },
      { key: "c", text: "Paired, Trips - 配對牌面" },
  ...
  },
  {
    id: "tx15",
    type: "postflop",
    question: "在 Low_conn 牌面如 7♠6♦5♣，開牌者應該如何調整策略？",
    options: [
      { key: "a", text: "降低 C-bet 頻率，這個牌面對跟注者有利" },
      { key: "b", text: "高頻小注" },
      { key: "c", text: "高頻大注" },
      { key: "d", text: "全下" },
    ],
  ...
  },
  {
    id: "tx16",
    type: "postflop",
    question: "T♠9♦7♣ 這個翻牌的 C-bet sizing 應該偏向？",
    options: [
      { key: "a", text: "大注（66-100%）- 對聽牌收費" },
      { key: "b", text: "小注（25-33%）" },
      { key: "c", text: "不應該 C-bet" },
      { key: "d", text: "Overbet" },
    ],
    correctAnswer: "a",
    explanation:
  ...
  },
  {
    id: "tx17",
    type: "postflop",
    question: "為什麼 ABB（如 A♠K♦Q♣）是 IP C-bet 頻率最高的質地類型之一？",
    options: [
      { key: "a", text: "開牌者範圍有大量 AK, AQ, Ax, KQ 等組合，範圍優勢極大" },
      { key: "b", text: "因為牌面很高" },
      { key: "c", text: "因為沒有同花聽牌" },
      { key: "d", text: "因為對手會害怕" },
    ],
  ...
  },
  {
    id: "tx18",
    type: "postflop",
    question: "花色分布（rainbow/twotone/monotone）如何影響基礎質地策略？",
    options: [
      { key: "a", text: "Monotone 降低 C-bet 頻率，Twotone 適度調整，Rainbow 不變" },
      { key: "b", text: "完全不影響" },
      { key: "c", text: "總是增加 C-bet 頻率" },
  ...
  },
  {
    id: "tx19",
    type: "postflop",
    question: "J♠8♦4♣ 這個翻牌屬於哪種類型？",
    options: [
      { key: "a", text: "JTx（J/T 高 + 不連接 low）" },
      { key: "b", text: "JT_conn" },
      { key: "c", text: "BBx" },
      { key: "d", text: "Low_unconn" },
    ],
  ...
  },
  {
    id: "tx20",
    type: "postflop",
    question: "為什麼 OOP（沒位置）在翻牌的 C-bet 策略和 IP 不同？",
    options: [
      { key: "a", text: "OOP 缺乏位置優勢，需要更極化（check 或大注）來補償" },
      { key: "b", text: "OOP 應該總是 check" },
      { key: "c", text: "OOP 和 IP 策略完全一樣" },
