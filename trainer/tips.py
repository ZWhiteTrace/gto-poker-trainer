...
RFI_RANGE_TIPS = {
    "UTG": {
        ...
        "suited_broadways": "QJs-Q9s (100%), Q8s (75%), JTs (100%), J9s (75%)",
        "suited_connectors": "T9s (75%), 98s-54s (25%)",
        "offsuit_aces": "ATo+ (100%), A9o (25%)",
        "offsuit_broadways": "KQo-QJo (100%), KTo/QTo (25%)",
    ...
    "HJ": {
        ...
        "suited_aces": "A2s+",
        "suited_kings": "K4s+",
        "suited_broadways": "Q8s+ (100%), Q7s-Q6s (75%), Q5s (25%), JTs-J8s (100%)",
        "suited_connectors": "T9s (100%), T8s (50%), 98s (50%), 87s-54s (25%)",
        "offsuit_aces": "A9o+ (100%), A8o (25%), A5o (25%)",
        "offsuit_broadways": "KQo-KTo (100%), QJo (100%), QTo (50%), JTo (50%)",
    ...
    "BTN": {
        ...
        "suited_broadways": "T9s-T6s (100%), T5s (25%)",
        "suited_connectors": "98s-96s (100%), 87s-86s (100%), 76s (100%), 75s (50%), 65s (100%), 54s (50%), 43s (25%)",
        "offsuit_aces": "A5o-A7o (100%), A4o (100%), A3o (50%)",
    ...
    "SB": {
        ...
        "suited_connectors": "T9s-T6s (100%), T5s (25%), 98s-96s (100%), 87s-85s (100%), 76s-75s (100%), 65s-64s (100%), 54s (100%), 53s (50%), 43s (25%)",
